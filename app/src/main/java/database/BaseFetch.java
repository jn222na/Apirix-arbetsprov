...
public abstract class BaseFetch extends AsyncTask<Object, Object, JSONObject> {
    ...
    public BaseFetch(String URL, String action, String token) {
        this.URL = URL;
        this.action = action;
        this.token = token;
        Log.d("DASDSADSA", "baseFetchbaseFetchbaseFetchbaseFetchbaseFetchbaseFetchbaseFetchbaseFetch: "+ this.message);
    }

    public BaseFetch(String URL, String action, String token, double startLatitude, double startLongitude, double endLatitude, double endLongitude) {
        this.URL = URL;
        this.action = action;
